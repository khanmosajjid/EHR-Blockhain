...
class DisplayPatient extends Component {
  ...
  async addConsultation(event) {
    ...
    let res = await this.doctorAddRecord.methods
    ...
    return (
      <div className="container-fluid">
        <div className="row">
          <Card
            bordered={true}
            style={{ width: "143%", border: "2px black solid" }}
          >
            ...
            <div style={{ overflowY: "auto", width: "100%", height: "310px" }}>
              <Collapse className="folderTab" defaultActiveKey={["1"]}>
                {doctorConsultation.map((doc, i) => {
                  let doctor_id = this.state.doctorConsultation[i]
                    ? this.state.doctorConsultation[i][0]
                    : null;
                  let consultation_advice = this.state.doctorConsultation[i]
                    ? this.state.doctorConsultation[i][1]
                    : null;
                  let medicine = this.state.doctorConsultation[i]
                    ? this.state.doctorConsultation[i][2]
                    : null;
                  let time_period = this.state.doctorConsultation[i]
                    ? this.state.doctorConsultation[i][3]
                    : null;
                  ...
                  return (
                    <DisplayConsultation that={this} props={consultProps} />
                  );
                })}
              </Collapse>
            </div>
                  ...
                  <tr>
                    <td>
                      <input
                        type="text"
                        id="time_period"
                        placeholder="time period / NA"
                      />
                    </td>
                  </tr>
                  <button className="button-12" type="submit" value="submit">
                    submit
                  </button>
                </table>
              </form>
